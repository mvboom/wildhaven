...
const WARN_PUG: String = "The Pug family will need a building and an open field to make their home."  # pipeline-generated (2026-08-30, scripts/style_guide_pipeline.py) -- AWAITING CONTENT-WRITER SIGN-OFF
...
const DEPART_PUG: String = "The Pug family found a new home with plenty of room to play and a cozy shelter."  # pipeline-generated (2026-08-30, scripts/style_guide_pipeline.py) -- AWAITING CONTENT-WRITER SIGN-OFF
...
const MOVE_PUG: String = "The Pug family has moved to a home with a spacious yard."  # pipeline-generated (2026-08-30, scripts/style_guide_pipeline.py) -- AWAITING CONTENT-WRITER SIGN-OFF
