extends QATestCase
## Import check — Pebble_Round_2 (grass-family rework, 2026-09-08). Raw glTF piece consumed directly
...
const MODEL_PATH: String = "res://assets/terrain/pebble_round_2/Pebble_Round_2.gltf"


func _init() -> void:
	begin("Pebble_Round_2 import")
	...
	if not check(inst != null, "Pebble_Round_2.gltf instantiates"):
		finish()
		return
