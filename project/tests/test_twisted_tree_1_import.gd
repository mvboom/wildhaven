extends QATestCase
## Import check — TwistedTree_1 (Forest MegaKit standardisation, 2026-09-08): the gnarled third silhouette, with its own bark and leaf texture set.
##
...
const MODEL_PATH: String = "res://assets/terrain/twisted_tree_1/TwistedTree1.tscn"


func _init() -> void:
	begin("TwistedTree_1 import")
	...
	if not check(inst != null, "TwistedTree1.tscn instantiates"):
		finish()
		return
