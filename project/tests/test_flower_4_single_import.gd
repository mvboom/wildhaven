extends QATestCase
## Import check — Flower_4_Single (grass-family rework, 2026-09-08). Raw glTF piece consumed directly
...
const MODEL_PATH: String = "res://assets/terrain/flower_4_single/Flower_4_Single.gltf"


func _init() -> void:
	begin("Flower_4_Single import")
	...
	if not check(inst != null, "Flower_4_Single.gltf instantiates"):
		finish()
		return
