extends QATestCase
## Import check — Clover_2 (grass-family rework, 2026-09-08). Raw glTF piece, NOT a wrapper
...
const MODEL_PATH: String = "res://assets/terrain/clover_2/Clover_2.gltf"


func _init() -> void:
	begin("Clover_2 import")
	...
	if not check(inst != null, "Clover_2.gltf instantiates"):
		finish()
		return
