extends QATestCase
## Import check — Grass_Wispy_Tall (grass-family rework, 2026-09-08). Raw glTF piece, NOT a wrapper
...
const MODEL_PATH: String = "res://assets/terrain/grass_wispy_tall/Grass_Wispy_Tall.gltf"


func _init() -> void:
	begin("Grass_Wispy_Tall import")
	...
	if not check(inst != null, "Grass_Wispy_Tall.gltf instantiates"):
		finish()
		return
