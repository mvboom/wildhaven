extends QATestCase
## Import check — Bush_Common (grass-family rework, 2026-09-08). Raw glTF piece consumed directly
...
const MODEL_PATH: String = "res://assets/terrain/bush_common/Bush_Common.gltf"


func _init() -> void:
	begin("Bush_Common import")
	...
	if not check(inst != null, "Bush_Common.gltf instantiates"):
		finish()
		return
