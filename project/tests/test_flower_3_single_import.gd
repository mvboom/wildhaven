extends QATestCase
## Import check — Flower_3_Single (grass-family rework, 2026-09-08). Raw glTF piece consumed directly
...
const MODEL_PATH: String = "res://assets/terrain/flower_3_single/Flower_3_Single.gltf"


func _init() -> void:
	begin("Flower_3_Single import")
	...
	if not check(inst != null, "Flower_3_Single.gltf instantiates"):
		finish()
		return
