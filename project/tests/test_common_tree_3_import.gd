extends QATestCase
## Import check — CommonTree_3 (Forest MegaKit standardisation, 2026-09-08): a third round-canopy broadleaf matching CommonTree1/2, which replaced the dropped Pine1 after a human look.
##
...
const MODEL_PATH: String = "res://assets/terrain/common_tree_3/CommonTree3.tscn"


func _init() -> void:
	begin("CommonTree_3 import")
	...
	if not check(inst != null, "CommonTree3.tscn instantiates"):
		finish()
		return
