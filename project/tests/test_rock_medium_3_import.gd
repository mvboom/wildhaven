extends QATestCase
## Import check — Rock_Medium_3 (grass-family rework, 2026-09-08). Raw glTF piece consumed directly
...
const MODEL_PATH: String = "res://assets/terrain/rock_medium_3/Rock_Medium_3.gltf"


func _init() -> void:
	begin("Rock_Medium_3 import")
	...
	if not check(inst != null, "Rock_Medium_3.gltf instantiates"):
		finish()
		return
