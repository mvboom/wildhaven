...
| House (1×1) | ~15 Wood | **Farmhouse** (2×2) ~30 Wood — its own buildable since D-52 |
...
| 4 | Build | House at 1×1, grass only; the 2×2 role is **Farmhouse**, its own buildable (D-52), and is what a villager *family* gates on. **A villager moves in when its habitat is met** ships whole — the USP requires the proof, not the building. |
