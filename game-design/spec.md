...
- The **Read-Aloud button** (🔊) is present on the fact card — floor and full alike, and on both of the card's entry points (a species' first-ever arrival, and an Inspect tap). It is **not** on the displacement warning panel or the top-centre toasts. Wider coverage (News Reports, Field Guide) is deferred (future.md).
