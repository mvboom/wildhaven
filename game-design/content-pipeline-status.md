...
| Field | Value |
|---|---|
| `category_attributes` | emits `cover` + `rocks`; `rocks` is load-bearing for Donkey/Alpaca/Shiba Inu/Stag habitat, `cover` has had no consumer since D-52; free to paint — [terrain.md](terrain.md#already-defined-terrain) |
